...
--
-- Host: 127.0.0.1
-- Generation Time: Wrz 13, 2024 at 01:59 PM
...
-- Database: `baza_osoby`
--
CREATE DATABASE IF NOT EXISTS `baza_osoby` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `baza_osoby`;
...
--
ALTER TABLE `osoby`
  MODIFY `lp` int(7) NOT NULL AUTO_INCREMENT;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"baza_osoby\",\"table\":\"osoby\"}]');
...
('root', '2024-09-13 11:59:33', '{\"Console\\/Mode\":\"show\",\"lang\":\"pl\",\"Console\\/Height\":95.98599999999999}');
